...
export interface BiographySliceDefaultPrimary {
   ...
   * - **Placeholder**: *None*
   * - **API ID Path**: biography.default.primary.desciption
   * - **Documentation**: https://prismic.io/docs/fields/rich-text
   */
  desciption: prismic.RichTextField;
...
/**
 * Primary content in *LinkProject → Default → Primary*
 */
export interface LinkProjectSliceDefaultPrimary {
  /**
   * Button Label field in *LinkProject → Default → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: link_project.default.primary.button_label
   * - **Documentation**: https://prismic.io/docs/fields/text
   */
  button_label: prismic.KeyTextField;

  /**
   * Button Link field in *LinkProject → Default → Primary*
   *
   * - **Field Type**: Link
   * - **Placeholder**: *None*
   * - **API ID Path**: link_project.default.primary.button_link
   * - **Documentation**: https://prismic.io/docs/fields/link
   */
  button_link: prismic.LinkField<
    string,
...
/**
 * Default variation for LinkProject Slice
 *
 * - **API ID**: `default`
 * - **Description**: Default
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type LinkProjectSliceDefault = prismic.SharedSliceVariation<
  "default",
  Simplify<LinkProjectSliceDefaultPrimary>,
  never
>;

/**
 * Slice variation for *LinkProject*
 */
type LinkProjectSliceVariation = LinkProjectSliceDefault;

/**
 * LinkProject Shared Slice
 *
 * - **API ID**: `link_project`
 * - **Description**: LinkProject
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type LinkProjectSlice = prismic.SharedSlice<
  "link_project",
